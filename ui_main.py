...
"}")
        ...
        # self.frm = QLabel(self.page_scan)
        # self.frm.setFrameShape(QFrame.Panel)
        # self.frm.setGeometry(QRect(40, 16, 531, 361))

        self.btn_scanstart = QPushButton("Start Capture", self.page_scan)
        self.btn_scanstart.setGeometry(QRect(500, 200, 181, 51))
        # sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.btn_toggle_menu.sizePolicy().hasHeightForWidth())
        # self.btn_scanstart.setSizePolicy(sizePolicy)
        # font8 = QFont()
        # font8.setFamily(u"Segoe UI")
        # font8.setPointSize(9)
        self.btn_scanstart.setFont(font8)
        self.btn_scanstart.setStyleSheet(u"QPushButton {\n"
"	border: 2px solid rgb(52, 59, 72);\n"
"	border-radius: 5px;	\n"
"	background-color: rgb(52, 59, 72);\n"
"}\n"
...
"}")
        ...
        self.btn_scanstart.clicked.connect(self.btnCapture)
        self.comboBoxT = QComboBox(self.page_scan)
        self.comboBoxT.setGeometry(QRect(30, 30, 421, 30))
        self.comboBoxT.setObjectName("comboBoxT")
        self.comboBoxT.setStyleSheet(u"QComboBox{\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding: 5px;\n"
...
"	selection-background-color: rgb(39, 44, 54);\n"
"}")
        self.graphicsViewT = QGraphicsView(self.page_scan)
        self.graphicsViewT.setGeometry(QRect(30, 70, 421, 311))
        self.graphicsViewT.setObjectName("graphicsViewT")
        scene = QGraphicsScene(self.page_scan)
        self.graphicsViewT.setScene(scene)
        self.comboBoxT.currentIndexChanged.connect(self.comboChange)
        self.bLoaded =1
        self.comboitems()

        self.frame_scan = QFrame(self.page_scan)
        self.frame_scan.setObjectName(u"frame_2")
        self.frame_scan.setMinimumSize(QSize(0, 150))
        self.frame_scan.setStyleSheet(u"background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        self.frame_scan.setFrameShape(QFrame.StyledPanel)
        self.frame_scan.setFrameShadow(QFrame.Raised)
        self.frame_scan.setGeometry(QRect(500, 30, 181, 131))
        self.label_scan=QLabel("Scanner Selection",self.frame_scan)
        self.label_scan.setGeometry(QRect(20,5,150,15))
        self.check_scan1=QCheckBox("Scanner 1", self.frame_scan)
        self.check_scan1.setGeometry(QRect(5,20,100,25))
        self.check_scan2=QCheckBox("Scanner 2", self.frame_scan)
        self.check_scan2.setGeometry(QRect(5,45,100,25))
        self.check_scan3=QCheckBox("Scanner 3", self.frame_scan)
        self.check_scan3.setGeometry(QRect(5,70,100,25))
        self.label_scan.setFont(font8)
        self.check_scan1.setFont(font8)
        self.check_scan2.setFont(font8)
        self.check_scan3.setFont(font8)

        self.btn_analysis = QPushButton("Analysis", self.page_scan)
        self.btn_analysis.setGeometry(QRect(500, 261, 181, 51))
        # sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.btn_toggle_menu.sizePolicy().hasHeightForWidth())
        ...
        # font8.setFamily(u"Segoe UI")
        # font8.setPointSize(9)
        self.btn_analysis.setFont(font8)
        self.btn_analysis.setStyleSheet(u"QPushButton {\n"
"	border: 2px solid rgb(52, 59, 72);\n"
"	border-radius: 5px;	\n"
"	background-color: rgb(52, 59, 72);\n"
"}\n"
...
"}")
        ...
        self.btn_analysis.clicked.connect(self.btnAnalysis)

        self.log_text = QTextBrowser(self.page_scan)
        self.log_text.setObjectName(u"log_text")
        self.log_text.setFont(font8)
        self.log_text.setGeometry(QRect(30, 395, 651, 200))
        self.log_text.setMinimumSize(QSize(200, 200))
        self.log_text.setStyleSheet(u"QTextBrowser {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	padding: 10px;\n"
"}\n"
...
############################################## page_scan_grid
        self.page_scan_grid = QWidget()
        self.page_scan.setObjectName(u"page_scan_grid")
        self.stackedWidget.addWidget(self.page_scan_grid)

        self.gridLayout_G = QGridLayout(self.page_scan_grid)
        self.gridLayout_G.setObjectName("gridLayout_G")
        self.gridLayout_A = QGridLayout()
        self.gridLayout_A.setObjectName("gridLayout_A")
        self.pushButton_9 = QPushButton("Start Capture", self.page_scan_grid)
        self.pushButton_9.setMinimumSize(QSize(180, 50))
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.gridLayout_A.addWidget(self.pushButton_9, 2, 3, 2, 2)
        self.frame_G = QFrame(self.page_scan_grid)
        self.frame_G.setMinimumSize(QSize(180, 130))
        self.frame_G.setMaximumSize(QSize(16777215, 16777215))
        self.frame_G.setFrameShape(QFrame.StyledPanel)
        self.frame_G.setFrameShadow(QFrame.Raised)
        self.frame_G.setObjectName("frame_G")
        self.frame_G.setStyleSheet(u"background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        self.label_A = QLabel("Scan Selection", self.frame_G)
        self.label_A.setGeometry(QRect(13, 7, 150, 12))
        self.label_A.setObjectName("label_A")
        self.checkBox__1 = QCheckBox("Scanner 1", self.frame_G)
        self.checkBox__1.setGeometry(QRect(10, 30, 81, 25))
        self.checkBox__1.setObjectName("checkBox__1")
        self.checkBox__2 = QCheckBox("Scanner 2", self.frame_G)
        self.checkBox__2.setGeometry(QRect(10, 55, 81, 25))
        self.checkBox__2.setObjectName("checkBox__2")
        self.checkBox__3 = QCheckBox("Scanner 3", self.frame_G)
        self.checkBox__3.setGeometry(QRect(10, 80, 81, 25))
        self.checkBox__3.setObjectName("checkBox__3")
        self.gridLayout_A.addWidget(self.frame_G, 0, 3, 2, 2)
        self.comboBox_G = QComboBox(self.page_scan_grid)
        self.comboBox_G.setMinimumSize(QSize(420, 30))
        self.comboBox_G.setObjectName("comboBox_G")
        self.comboBox_G.setStyleSheet(u"QComboBox{\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	border: 2px solid rgb(27, 29, 35);\n"
"	padding: 5px;\n"
...
"	selection-background-color: rgb(39, 44, 54);\n"
"}")
        self.gridLayout_A.addWidget(self.comboBox_G, 0, 0, 1, 2)
        self.pushButton_7 = QPushButton("Analysis", self.page_scan_grid)
        self.pushButton_7.setMinimumSize(QSize(180, 50))
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.gridLayout_A.addWidget(self.pushButton_7, 4, 3, 1, 2)
        self.textBrowser_G = QTextBrowser(self.page_scan_grid)
        self.textBrowser_G.setMinimumSize(QSize(650, 200))
        self.textBrowser_G.setObjectName("textBrowser_G")
        self.textBrowser_G.setStyleSheet(u"QTextBrowser {\n"
"	background-color: rgb(27, 29, 35);\n"
"	border-radius: 5px;\n"
"	padding: 10px;\n"
"}\n"
...
"	border: 2px solid rgb(91, 101, 124);\n"
"}")
        self.gridLayout_A.addWidget(self.textBrowser_G, 8, 0, 1, 5)
        self.graphicsView_G = QGraphicsView(self.page_scan_grid)
        self.graphicsView_G.setMinimumSize(QSize(420, 310))
        self.graphicsView_G.setObjectName("graphicsView_G")
        self.gridLayout_A.addWidget(self.graphicsView_G, 1, 0, 7, 2)
        self.label_G = QLabel(self.page_scan_grid)
        self.label_G.setText("")
        self.label_G.setObjectName("label_G")
        self.gridLayout_A.addWidget(self.label_G, 0, 2, 3, 1)
        self.gridLayout_A.setColumnStretch(0, 15)
        self.gridLayout_A.setColumnStretch(4, 4)
        self.gridLayout_A.setRowStretch(5, 5)
        self.gridLayout_A.setRowStretch(8, 3)
        self.gridLayout_G.addLayout(self.gridLayout_A, 0, 0, 1, 1)
        self.pushButton_7.setFont(font8)
        self.checkBox__1.setFont(font8)
        self.checkBox__2.setFont(font8)
        self.checkBox__3.setFont(font8)
        self.comboBox_G.setFont(font8)
        self.label_A.setFont(font8)
        self.comboBox_G.currentIndexChanged.connect(self.comboChange_G)
        self.comboitems_G()
        self.pushButton_9.clicked.connect(self.btnCapture_G)
        self.pushButton_7.clicked.connect(self.btnAnalysis_G)
...
## scan page : 원단 콤보목록 - 이미지 매칭
    def comboitems(self):
        ## Product name
        self.comboBoxT.addItem("NanoX_10A")
    ...
    def comboChange(self):
        index = self.comboBoxT.currentIndex()
        print(self.comboBoxT.itemText(index))
        if self.bLoaded:
            fname = "images/{}".format(self.imagename[self.comboBoxT.itemText(index)])
            fname = fname.replace("/","\\")
            print(fname)
            scene = QGraphicsScene(self.page_scan)
            ...
            item = QGraphicsPixmapItem(pixmap)
            scene.addItem(item)
            if  len(self.comboBoxT.itemText(index)) > 8 :
                self.productName = self.comboBoxT.itemText(index)[0:8]
            self.graphicsViewT.setScene(scene)
...
## scan page : log
    def writeLog1(self, text):
        ...
        self.log_text.append("[{T}], {str}".format(T=date_time, str=text))

## scan page : analysis
    def btnAnalysis(self):
        self.writeLog1("Button Analysis Clicked!")
        process0 = subprocess.Popen("python Analysis_main.py")
...
## scan page : 캡처
    def btnCapture(self):
        ...
        if self.beingCapture: ## Code Stop
            ...
            print("Capture Stop")
            self.btn_scanstart.setText("Start Capture")
            self.beingCapture = 0
...
## scan page : 원단 콤보목록 - 이미지 매칭
    def comboitems_G(self):
        ...
        for row in c.execute('SELECT * FROM app_textiles'):
            self.comboBox_G.addItem(row[2])
            self.imagename[row[2]] = row[14]

        print(self.imagename)

        scene = QGraphicsScene(self.page_scan_grid)
        pixmap = QPixmap("textile_selected.png")
        item = QGraphicsPixmapItem(pixmap)
        scene.addItem(item)
        self.graphicsView_G.setScene(scene)

    def comboChange_G(self):
        index = self.comboBox_G.currentIndex()
        print(self.comboBox_G.itemText(index))
        if self.bLoaded:
            fname = "images/{}".format(self.imagename[self.comboBox_G.itemText(index)])
            fname = fname.replace("/","\\")
            print(fname)
            scene = QGraphicsScene(self.page_scan_grid)
            pixmap = QPixmap(fname)
            item = QGraphicsPixmapItem(pixmap)
            scene.addItem(item)
            if  len(self.comboBox_G.itemText(index)) > 8 :
                self.productName = self.comboBox_G.itemText(index)[0:8]
            self.graphicsView_G.setScene(scene)

## scan page : log
    def writeLog1_G(self, text):
        now = datetime.now()
        date_time = now.strftime("%m/%d/%Y, %H:%M:%S")
        print("date and time:", date_time)
        self.textBrowser_G.append("[{T}], {str}".format(T=date_time, str=text))

## scan page : analysis
    def btnAnalysis_G(self):
        self.writeLog1_G("Button Analysis Clicked!")
        process0 = subprocess.Popen("python Analysis_main.py")

## scan page : 캡처
    def btnCapture_G(self):
        print(sys.argv)

        if self.beingCapture: ## Code Stop
            self.writeLog1_G("Capture Stop")
            print("Capture Stop")
            self.pushButton_9.setText("Start Capture")
            self.beingCapture = 0
            os.makedirs('stopframe')
        else:
            self.writeLog1_G("Capture Start")
            if os.path.isdir('stopframe'):
                os.rmdir('stopframe')
            self.beingCapture= 1
            print("Capture Start")
            self.pushButton_9.setText("Stop Capture")
            self.runcapture_G(self.productName)
        print("Capture Button Clicked")

    def runcapture_G(self, productname):
        if self.checkBox__1.isChecked():
            self.writeLog1_G("Camera [0] Start")
            process0 = subprocess.Popen("python CameraCapture.py {} 0 1".format(productname))
        if self.checkBox__2.isChecked():
            self.writeLog1_G("Camera [1] Start")
            process1 = subprocess.Popen("python CameraCapture.py {} 1 1".format(productname))
        if self.checkBox__3.isChecked():
            self.writeLog1_G("Camera [2] Start")
            process2 = subprocess.Popen("python CameraCapture.py {} 2 1".format(productname))